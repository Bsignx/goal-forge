...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="#features"
              className="px-6 py-3 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-foreground font-medium rounded-lg transition-colors"
            >
              Learn More
            </Link>
          </div>
      ...
      <section
        id="features"
        className="py-16 border-t border-zinc-200 dark:border-zinc-800"
      >
